...
public class RecipeLoader implements Runnable {
    ...
    private static final String ASSETS_RECIPE_EASY_PATH = "/assets/appliedenergistics2/easyModeRecipes/";
    ...
    public final void run() {
        if (this.config.isEnabled()) {
            ...
            // on failure use jar parsing
                ...
                {
                    this.handler.parseRecipes(new JarLoader(ASSETS_RECIPE_EASY_PATH), "index.recipe");
                }
            }
        } else {
            this.handler.parseRecipes(new JarLoader(ASSETS_RECIPE_PATH), "index.recipe");
